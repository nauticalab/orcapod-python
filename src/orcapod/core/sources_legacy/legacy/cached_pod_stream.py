        ...
        **kwargs: Any,
        ...
        if self._cached_output_packets is None:
            ...
            target_entries = self.input_stream.as_table(
                include_content_hash=constants.INPUT_PACKET_HASH_COL,
                include_source=True,
            ...
            if existing_entries is None or existing_entries.num_rows == 0:
                missing = target_entries.drop_columns([constants.INPUT_PACKET_HASH_COL])
                existing = None
            else:
                all_results = target_entries.join(
                    ...
                    keys=[constants.INPUT_PACKET_HASH_COL],
                ...
                missing = (
                    ...
                    .drop_columns([constants.INPUT_PACKET_HASH_COL])
                )
        ...
        **kwargs: Any,
        ...
        if (
            ...
            all_results_df = target_df.join(
                existing_df,
                on=constants.INPUT_PACKET_HASH_COL,
                how="left",
                suffix="_right",
            )
