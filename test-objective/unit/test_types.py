...
class TestSchemaImmutableMapping:
    ...
    def test_schema_equality(self):
        a = Schema({"x": pa.int64(), "y": pa.utf8()})
        b = Schema({"x": pa.int64(), "y": pa.utf8()})
        assert a == b

    def test_schema_inequality_different_types(self):
        a = Schema({"x": pa.int64()})
        b = Schema({"x": pa.float64()})
        assert a != b
...
class TestSchemaOptionalFields:
    ...
    def test_optional_fields_set_at_construction(self):
        s = Schema({"x": pa.int64(), "y": pa.utf8()}, optional_fields={"y"})
    ...
    def test_optional_fields_can_include_unknown_fields(self):
        ...
        s = Schema({"x": pa.int64()}, optional_fields={"z"})
...
class TestSchemaMerge:
    ...
    def test_merge_overlapping_same_type(self):
        a = Schema({"x": pa.int64(), "y": pa.utf8()})
        b = Schema({"x": pa.int64(), "z": pa.float64()})
        merged = a.merge(b)
        assert merged["x"] == pa.int64()
        assert "z" in merged
...
class TestSchemaSelect:
    ...
    def test_select_existing_fields(self):
        s = Schema({"x": pa.int64(), "y": pa.utf8(), "z": pa.float64()})
...
class TestSchemaCompatibility:
    ...
    def test_compatible_when_other_is_superset(self):
        small = Schema({"x": pa.int64()})
        big = Schema({"x": pa.int64(), "y": pa.utf8()})
...
class TestSchemaWithValues:
    ...
    def test_with_values_adds_new_field(self):
        s = Schema({"x": pa.int64()})
        updated = s.with_values({"y": pa.utf8()})
        assert "y" in updated
        assert "x" in updated

    def test_with_values_overrides_existing_type(self):
        s = Schema({"x": pa.int64()})
        updated = s.with_values({"x": pa.float64()})
        assert updated["x"] == pa.float64()

    def test_with_values_does_not_mutate_original(self):
        s = Schema({"x": pa.int64()})
        s.with_values({"x": pa.float64()})
        assert s["x"] == pa.int64()
